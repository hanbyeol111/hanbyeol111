...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _fetchQuizs() async{
    ...
    // final uri = Uri.parse('https://hanstar.pythonanywhere.com/quiz/7/');
    var uri = Uri.parse("https://hanstar.pythonanywhere.com/quiz/7/");
        ...
        child: Scaffold(
          ...
          body: Column(
           ...
           children: <Widget>[
            ...
            _buildStep(width, '1. 매주 한번씩 진행되는 주간복습테스트를 풀어보세요'),
